...
def analyze_audio(input_audio_path):
    ...
    if mfcc_features is not None:
        ...
        if prediction[0] == 0:
            print("Deepfake audio로 판정되었습니다.")
            return True
        else:
            print("Real audio로 판정되었습니다.")
            return False
    else:
        print("Error: Unable to process the input audio.")

def main():
    genuine_dir = r"datasets/trump/real/combined"
    deepfake_dir = r"datasets/trump/fake/combined"
...
if __name__ == "__main__":
    ...
    user_input_file = input("Firebase 연동할 것, 오디오 파일 위치: ")
